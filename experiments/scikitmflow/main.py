...
datasets = [
    ...
    #     "rbf": {"sigma": 2.5, "lambda_": 0.5, "alpha": 0.15, "delta": 1.0}
    # },
    # {
    #     "name": "abrupt",
    #     "path": os.path.join(os.path.curdir, "data", "abrupt.arff"),
    #     "rbf": {"sigma": 2.5, "lambda_": 0.5, "alpha": 0.005, "delta": 1.0}
    # },
    {
        "name": "gamaabrupt",
        "path": os.path.join(os.path.curdir, "data", "gamaabrupt.arff"),
        "rbf": {"sigma": 2.5, "lambda_": 0.5, "alpha": 0.001, "delta": 0.70}
    },
    # {
    #     "name": "gradual",
...
for dataset in datasets:
    ...
    plot = RBFPlot(suptitle=dataset["name"], step=25)
    rbf = RBF(**dataset["rbf"])
