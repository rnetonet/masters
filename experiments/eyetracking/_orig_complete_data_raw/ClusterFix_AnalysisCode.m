...
for ii = 1:size(fixclusters,2)
    plot3(fixclusters(1,ii),fixclusters(2,ii),freq*fixclusters(3,ii),'r.')
end
for ii = 1:size(sacclusters,2)
    plot3(sacclusters(1,ii),sacclusters(2,ii),freq*sacclusters(3,ii),'g.')
    %*freq to convert from degrees/sample to degrees/sec
end
view(3)
