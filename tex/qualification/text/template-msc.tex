...
\title{Aplicando Redes de Função de Base Radial e Cadeias de Markov para a detecção online de mudanças de conceito em fluxos contínuos de dados}
...
Estas alterações são denominadas mudanças de conceito e podem impactar negativamente a performance de sistemas ou modelos consumidores dos dados.
...
Este trabalho de mestrado propõe um novo método de detecção baseado em Redes de Função de Base Radial (RBF) e Cadeias de Markov.
...
Os resultados obtidos com conjuntos de dados sintéticos permitem demonstrar a viabilidade do método,
tendo sido apresentado um desempenho superior ou similar ao de algoritmos consolidados na literatura, em termos de acurácia média e tempo de processamento.
