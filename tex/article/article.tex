...
These methods or require the correct labeling of data (impracticable in these contexts) and detect drift through the monitoring of the system performance,
...
and employs Markov Chains to model the transitions and accomplish noise tolerance.
...
Moreover, the algorithm was also tested with the real-world problem of eye-tracking.
