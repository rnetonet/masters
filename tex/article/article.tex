...
The algorithm continually groups the incoming data through Radial Basis Function Networks and maintains a model of the drift transitions in a Markov Chain.
Drifts are detected when the probability of a transition reaches a parametric threshold.
