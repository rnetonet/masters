...
Visando resolver essas limitações, este projeto de mestrado propõe um algoritmo baseado em Redes de Função de Base Radial capaz de detectar mudanças de conceito em tempo de execução, de forma precisa e sem depender da correta rotulação dos eventos.
