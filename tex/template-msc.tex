...
No instante $T4$, o valor $0.34$ não atinge o valor mínimo de ativação (\texttt{$\epsilon$}) para ser vinculado ao centro ativo ($0.11$). 
...
\begin{figure}[H]
\begin{center}
    \includegraphics[height=0.8\textheight]{imagens/funcionamento_algoritmo.png}
...
\begin{algorithm}[H]
    ...
    \uIf{$centroAtual == null$}{
        $centroAtual \leftarrow valor$ \\
    }
    \uIf{$centroAtual \neq centroAtivo$}{
