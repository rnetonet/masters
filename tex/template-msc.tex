...
Graças a essas mudanças e à robusta expansão da pesquisa em Aprendizado de Máquina (AM), é crescente o interesse na adaptação destas técnicas para cenários com FCDs.
...
Segundo \cite{Gama:2010:KDD:1855075}, a área de AM dedicou-se durante muitos anos em resolver problemas de aprendizado não-incrementais (\textit{batch}), especialmente para tarefas de classificação.
Estes cenários consideram que a distribuição dos dados é estacionária, ou seja, o conjunto de conceitos-alvo não sofre modificações, 
