...
Dessa forma, a criação de novos centros e ou a mudança do centro ativo podem sinalizar a ocorrência de mudanças de conceito.
...
Permitindo que as redes identifiquem exemplos divergentes dos padrões conhecidos.
...
Este capítulo descreve como a pesquisa proposta neste mestrado será desenvolvida para permitir que redes de função de base radial sejam aplicadas na detecção de mudanças de conceito em fluxos contínuos de dados.
