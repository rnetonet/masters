...
%
Na literatura estas sequências são denominadas Fluxos Contínuos de Dados (FCDs) e estão presentes em diversos domínios de aplicação, por exemplo:
climatologia, 
...
Contudo, as técnicas mencionadas dependem que o rótulo correto de cada exemplo esteja disponível.
...
Os métodos de detecção independentes de rótulos baseiam-se na identificação de eventos que não se enquadram na atual estrutura dos dados \cite{Spinosa:2007:OCA:1244002.1244107}.
