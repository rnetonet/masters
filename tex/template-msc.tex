...
%
Inicialmente, serão abordadas as características dos fluxos contínuos de dados e a aplicação de técnicas de aprendizado de máquina nestes cenários.
%
Em seguida, será discutidada a ideia de mudança de conceito, seus tipos e características, terminologia, principais algoritmos de detecção e ferramentas.
%
...
%
Ambas as categorias foram especializadas para que pudessem ser aplicadas a cenários com fluxos contínuos de dados.
%
As características de cada categoria e as principais especializações serão discutidas a seguir.
...
Sendo assim, foram desenvolvidos métodos não supervisionados especializados para fluxos contínuos de dados \cite{Aggarwal:2003:FCE:1315451.1315460}.
...
Os algoritmos supervisionados realizam predições para novos exemplos utilizando um modelo de decisão criado a partir de uma base de treinamento \cite{Kotsiantis:2007:SML:1566770.1566773}.
...
Os principais algoritmos supervisionados para cenários em lote são:
...
não é possível aplicar as técnicas supervisionadas tradicionais em contextos com fluxos contínuos de dados, 
pois estes métodos não contemplam as severas restrições de uso de memória e de tempo de execução.
%
Dessa forma, 
novos algoritmos supervisionados foram propostos para esses cenários \cite{Domingos:2000:MHD:347090.347107, Bifet:2013:EDS:2480362.2480516, Wang:2003:MCD:956750.956778, Aggarwal:2004:DCD:1014052.1014110, Gama:2003:ADT:956750.956813}.
...
Isto é, a distribuição dos dados ou o contexto do processo gerador podem sofrer variações, alterando os resultados esperados.
Na literatura, essas alterações são denominadas mudanças de conceito \cite{Gama:2010:KDD:1855075} e a sua ocorrência pode impactar a acurácia do algoritmo.
...
% Conforme \citeonline{Zliobaite:2010} e com base na formalização apresentada, é possível definir que mudanças de conceito ocorrem devido a:
...
Na próxima subseção, será discutida a terminologia da área de mudança de conceito.
...
As técnicas para detecção de \textit{outliers} têm como objetivo encontrar padrões de dados em desacordo com o comportamento esperado, geralmente classificados como anomalias ou ruídos \cite{Chandola:2009:ADS:1541880.1541882}.
...
Por fim, os métodos para detecção de mudanças de conceito monitoram a distribuição dos dados ou indicadores (por exemplo: taxa de erro) das técnicas de aprendizado aplicadas, a fim de identificar a ocorrência de mudanças de conceito, permitindo a atualização do modelo \cite{Gama:2014:SCD:2597757.2523813}.

Neste trabalho, uma nova abordagem para detecção de mudanças de conceito baseada em redes de função de base radial é proposta.
Na próxima subseção, as técnicas para detecção de mudança de conceito serão discutidas com maior profundidade.
