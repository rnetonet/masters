...
Todavia, segundo \cite{Aggarwal:2006:DSM:1196418, Gama:2014:SCD:2597757.2523813},
...
A metodologia proposta se diferencia por detectar mudanças em tempo de execução, de forma computacionalmente eficiente e independente de rótulos.

\section{Hipótese e Objetivo}

Com base nas observações citadas anteriormente, a seguinte hipótese foi formulada:

% “O agrupamento de séries temporais apresenta maior acurácia quando medidas de
% similaridade (ou distância) são, individualmente, calculadas sobre comportamentos
% estocásticos e determinı́sticos.”
