...
Este capítulo apresenta uma discussão sobre conceitos importantes no contexto deste trabalho de pesquisa.
Em primeiro momento, serão apresentados conceitos sobre Fluxos Contínuos de Dados.
Em seguida, serão descritas noções sobre Mudança de Conceito, seus tipos e características, além dos principais algoritmos de detecção e ferramentas.
