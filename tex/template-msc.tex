...
\begin{center} 
    ...
    \hline
    \textbf{Indicador} & \textbf{Observação} \\
    \hline
    \hline
    \textit{Tempo de Processamento}    &  Tempo médio (segundos) de processamento para cada exemplo. \\
    \textit{Mudanças Existentes}       &  Quantidade de mudanças existentes de fato. \\
    \textit{Mudanças Detectadas}       &  Quantidade de mudanças detectadas. \\
    \textit{Mudanças Reais Detectadas} &  Quantidade de mudanças detectadas corretamente. \\
    \textit{Atraso de Detecção}        &  Quantidade média de instâncias necessárias para detectar uma mudança. \\
    \hline
    \end{tabular}
    \end{table}
\end{center}
