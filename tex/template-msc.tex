...
Este capítulo descreve como a pesquisa proposta neste mestrado será desenvolvida para que redes de função de base radial possam detectar mudanças de conceito em fluxos contínuos de dados.
