...
Voltando às técnicas de aprendizado de máquina, cabe destacar que estes algoritmos dividem-se em duas categorias principais: 
...
E que algoritmos de ambas as categorias foram adaptados para que pudessem ser aplicados à cenários com fluxos contínuos de dados.
...
No contexto deste trabalho de mestrado, assume-se que os dados são obtidos a partir de fluxos contínuos de dados dinâmicos.
O algoritmo para detecção de mudanças de conceito proposto é independente de técnicas de aprendizado, 
pois identifica as mudanças a partir de uma análise direta e contínua do fluxo de dados.
Na próxima seção, o fenômeno mudança de conceito e as suas técnicas de detecção serão discutidas.
