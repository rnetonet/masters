...
%
Em seguida, será discutidada a ideia de mudança de conceito, seus tipos e características, taxonomia, principais algoritmos de detecção e ferramentas.
%
...
%
Estes algoritmos dividem-se em duas categorias principais: 
%
...
De acordo com \citeonline{Gama:2010:KDD:1855075}, a principal dificuldade ao aplicar técnicas não supervisionadas em cenários com fluxos contínuos de dados é a manutenção da qualidade e consistência dos grupos formados conforme novos dados são observados.
...
Sendo assim, foram desenvolvidos algoritmos não supervisionados especializados para fluxos contínuos de dados \cite{Aggarwal:2003:FCE:1315451.1315460}.
Os seguintes algoritmos são exemplos dessas especializações:
...
Na literatura, essas alterações são denominadas mudanças de conceito \cite{Gama:2010:KDD:1855075} e a sua ocorrência pode impactar a acurácia da técnica utilizada.
