...
Durante este processo, divergências são utilizadas para identificar mudanças \cite{Gama:2014:SCD:2597757.2523813}.
...
Conforme \cite{Aggarwal:2004:DCD:1014052.1014110}., as abordagens mencionadas nesta seção não são perfeitamente adequadas para cenários com fluxos contínuos de dados.
Pois, as técnicas dependentes de rótulo são impraticáveis em problemas do mundo real, por dependerem de um \textit{especialista} para cada análise.
De forma similar, os algoritmos independentes apresentam dificuldade para lidar com as restrições de tempo e processamento, inerentes a esses cenários.
