...
Os resultados dos experimentos justificaram a possibilidade de identificar mudanças de conceito em fluxos contínuos de dados 
utilizando redes de função de base radial.
