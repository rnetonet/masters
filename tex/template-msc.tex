...
Para mitigar este problema, foram desenvolvidas novas técnicas para detecção de mudanças de conceito.
Entretanto, as técnicas disponíveis na literatura ainda apresentam limitações ao serem aplicadas em cenários com fluxos contínuos, como a necessidade de rotulação por especialistas ou a incapacidade de atender às restrições de tempo de processamento e de uso dos recursos computacionais.
